...
const Forecast7Day = ({ forecast }) => {
   ...
   return (
      ...
      >
         ...
         <div className="rounded-2xl p-4 md:p-6 overflow-x-auto">
            <div className="flex flex-nowrap md:grid md:grid-cols-7 gap-4">
               {forecast.map((day, idx) => (
                  ...
                  >
                     ...
                     <div className="text-xs text-white/70 mt-1 capitalize text-center">
